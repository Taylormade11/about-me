...
alert('Remember ' + userName + ' to answer all questions with yes/no only. Each correct answer will award 1 point. Each incorrect answer will result in 1 strike. 3 strikes and you lose!');
...
if (bananaGuess === 'no') {
  ...
  strikesCounter += 1;
  alert('Incorrect! I can\'t eat a banana, the texture makes me yack! I drink one every day though! 1 strike for you! Only ' + (remainingStrikes - strikesCounter) + ' left!');
